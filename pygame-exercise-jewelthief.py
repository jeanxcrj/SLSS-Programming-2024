...
GOOMBA_IMAGE = pg.transform.scale( 
    GOOMBA_IMAGE,
    (GOOMBA_IMAGE.get_width()//12, GOOMBA_IMAGE.get_height() //12)
)
...
def start():
    ...
    while not done:
        ...
        # Collision between player and enemy_sprites
        coins_collided = pg.sprite.spritecollide(enemy, coin_sprites, True)
